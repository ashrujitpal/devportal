...
public class WelcomeController {
    ...
    @Autowired 
	private SubApiServiceImpl subApiService;
...
//    @GetMapping("/")
//    public String main(@RequestParam("pageSize") Optional<Integer> pageSize,
...
//	    	
//	    	Page<SubApiTbl> subapiDtls = subApiService.findAllPageable(PageRequest.of(evalPage, evalPageSize));
//	    	Pager pager = new Pager(subapiDtls.getTotalPages(), subapiDtls.getNumber(), BUTTONS_TO_SHOW);
//	    	
...
//    }
    ...
    public String main(Model model) {
    	   ...
    	   Iterable<SubApiTbl> subapiDtls = subApiService.findAll();
    	   model.addAttribute("subapilist", subapiDtls);
	    	return "index";
    }
